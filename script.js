...
const MASTER_KEY = 'YOUR_MASTER_KEY_HERE';  // Get from jsonbin.io
const BIN_ID = 'YOUR_BIN_ID_HERE';          // Your announcement bin ID
const GALLERY_BIN_ID = 'YOUR_GALLERY_BIN_ID_HERE'; // Your gallery bin ID
